...
import { createFeed } from "../../../../utils/api/Dashboard/Feed/feed.api";
import { useForm } from 'react-hook-form';
import "/src/assets/styles/Dashboard/Forms/Forms.css"
import Swal from 'sweetalert2'

function FeedForm({ onAdd }){
    ...
    return(
        <div className="form-container">
            <h3 className="text-center">Registra un nuevo alimento</h3>
            <form onSubmit={onSubmit} className="small-form">
                <div className="form-group">
                    <label htmlFor="name" className="form-label">Alimento</label>
